...
public class Leccion_2 {
    ...
    public static void main(String[] args) {
        ...
        var condicion = true;
        if (condicion) { // cuando usamos una variable de tipo booleana, poner que la condicion == true es redundar
            System.out.println("Condicion Verdadera"); //condicional simple : usamos solo el bloque if de la estructura de control           
        } // ya que el if trabaja de manera logica usando la inferencia de tipo var es que la variable condicion ya la hemos creado de tipo booleana
        else {
            System.out.println("Condicion Falsa"); //condicional doble : usamos el bloque if y else de la estructura de control
        }
